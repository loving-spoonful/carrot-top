        ...
        if (state === "signUp") {
            ...
            if (Meteor.user().profile.desired_role == "-- SELECT --") {
                sdi = Meteor.commonFunctions.popupOKModal("New Registered User!",
                    "Thank you for registering " + Meteor.user().emails[0].address + ".  Unfortunately, you have not specified your role properly.  Please contact Alexandra Harper, Food Access Animator, at food@lovingspoonful.org or 613-507-8848 to correct your account."
